...
<div class="lease-contract">
    <div class="container" style="font-family:thsarabun;">
        <h4 style="text-align: center;font-weight:bold;font-size:16pt;font-family:thsarabun;">สัญญาค้ำประกันเช่าอุปกรณ์ถ่ายภาพ<br>ร้านเช่ากล้อง ปัตตานี</h4>
        ...
        <h3 style="text-indent:30px;font-weight:bold">หากส่งอุปกรณ์ไม่ตรงตามเวลาที่กำหนด จะต้องจ่ายค่าปรับชั่วโมงละ 50 บาท</h3>
        <div>
            <br /><br />
